			  ...
			  <div class="modal-body">
					...
					<div class = "error"></div>
	                        	...
	                        	function changetp(){
									...
									message =	message.replace(/\{name\}/g, name); 
		 							...
		 							updatehref();                        		
                                       ...
                                       $('#showNote').on('click',function(ev){
                                            ev.preventDefault();
                                            var obj = $(this);
                                            $('#'+obj.data('sele')).toggle();
                                        });     
						...
						<input type="hidden" value = "" id = "ulink2" >
                                                <input type="text" name="note" value="" placeholder="Write note here" id="show_text_filed" style="display: none"/>
			  </div>
			  <div class="modal-footer">
				<div id = "m-link"></div>
                                
                                <button type="button" class="btn btn-primary"  id = "showNote" data-sele="show_text_filed" >Note</button>
